...
<html>
 ...
 echo rtrim(array_pop(explode("/",$data['dynamic_view']['img'])),"\"");
      ...
      <form action="" method="post" enctype="multipart/form-data" >
       ...
       <div class="display-bar"><input type="file" id="student_image" name="student_image" value="<?php echo array_pop(explode("/",$data['dynamic_view']['img'])) ?>" accept="image/*" ></div><div id="course_image_err" class="regErrorMessage"></div>
